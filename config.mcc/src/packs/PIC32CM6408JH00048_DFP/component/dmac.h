...
#define DMAC_SWTRIGCTRL_Msk                   _UINT32_(0x0000003F)                                 /* (DMAC_SWTRIGCTRL) Register Mask  */

#define DMAC_SWTRIGCTRL_SWTRIG_Pos            _UINT32_(0)                                          /* (DMAC_SWTRIGCTRL Position) Channel 5 Software Trigger */
#define DMAC_SWTRIGCTRL_SWTRIG_Msk            (_UINT32_(0x3F) << DMAC_SWTRIGCTRL_SWTRIG_Pos)       /* (DMAC_SWTRIGCTRL Mask) SWTRIG */
...
#define DMAC_INTSTATUS_Msk                    _UINT32_(0x0000003F)                                 /* (DMAC_INTSTATUS) Register Mask  */

#define DMAC_INTSTATUS_CHINT_Pos              _UINT32_(0)                                          /* (DMAC_INTSTATUS Position) Channel 5 Pending Interrupt */
#define DMAC_INTSTATUS_CHINT_Msk              (_UINT32_(0x3F) << DMAC_INTSTATUS_CHINT_Pos)         /* (DMAC_INTSTATUS Mask) CHINT */
...
#define DMAC_BUSYCH_Msk                       _UINT32_(0x0000003F)                                 /* (DMAC_BUSYCH) Register Mask  */

#define DMAC_BUSYCH_BUSYCH_Pos                _UINT32_(0)                                          /* (DMAC_BUSYCH Position) Busy Channel 5 */
#define DMAC_BUSYCH_BUSYCH_Msk                (_UINT32_(0x3F) << DMAC_BUSYCH_BUSYCH_Pos)           /* (DMAC_BUSYCH Mask) BUSYCH */
...
#define DMAC_PENDCH_Msk                       _UINT32_(0x0000003F)                                 /* (DMAC_PENDCH) Register Mask  */

#define DMAC_PENDCH_PENDCH_Pos                _UINT32_(0)                                          /* (DMAC_PENDCH Position) Pending Channel 5 */
#define DMAC_PENDCH_PENDCH_Msk                (_UINT32_(0x3F) << DMAC_PENDCH_PENDCH_Pos)           /* (DMAC_PENDCH Mask) PENDCH */
...
#endif /* _PIC32CMJH00_DMAC_COMPONENT_H_ */
