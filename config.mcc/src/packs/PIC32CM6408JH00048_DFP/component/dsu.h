...
#define DSU_CTRL_ARR(value)                   (DSU_CTRL_ARR_Msk & (_UINT8_(value) << DSU_CTRL_ARR_Pos)) /* Assignment of value for ARR in the DSU_CTRL register */
...
#define DSU_CTRL_SMSA(value)                  (DSU_CTRL_SMSA_Msk & (_UINT8_(value) << DSU_CTRL_SMSA_Pos)) /* Assignment of value for SMSA in the DSU_CTRL register */
...
#define DSU_STATUSC_STATE(value)              (DSU_STATUSC_STATE_Msk & (_UINT8_(value) << DSU_STATUSC_STATE_Pos)) /* Assignment of value for STATE in the DSU_STATUSC register */
...
#define DSU_DID_RESETVALUE                    _UINT32_(0x11000502)                                 /*  (DSU_DID) Device Identification  Reset Value */
...
#endif /* _PIC32CMJH00_DSU_COMPONENT_H_ */
