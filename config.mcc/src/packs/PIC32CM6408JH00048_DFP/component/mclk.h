...
#define MCLK_AHBMASK_HSRAM(value)             (MCLK_AHBMASK_HSRAM_Msk & (_UINT32_(value) << MCLK_AHBMASK_HSRAM_Pos)) /* Assignment of value for HSRAM in the MCLK_AHBMASK register */
...
#define MCLK_AHBMASK_NVMCTRL_PICACHU(value)   (MCLK_AHBMASK_NVMCTRL_PICACHU_Msk & (_UINT32_(value) << MCLK_AHBMASK_NVMCTRL_PICACHU_Pos)) /* Assignment of value for NVMCTRL_PICACHU in the MCLK_AHBMASK register */
...
#define MCLK_AHBMASK_Msk                      _UINT32_(0x00001CFF)                                 /* (MCLK_AHBMASK) Register Mask  */
...
#define MCLK_APBAMASK_Msk                     _UINT32_(0x00000FFF)                                 /* (MCLK_APBAMASK) Register Mask  */
...
#define MCLK_APBCMASK_Msk                     _UINT32_(0x00D3FE1F)                                 /* (MCLK_APBCMASK) Register Mask  */

#define MCLK_APBCMASK_SERCOM_Pos              _UINT32_(1)                                          /* (MCLK_APBCMASK Position) SERCOMx APB Clock Enable */
#define MCLK_APBCMASK_SERCOM_Msk              (_UINT32_(0xF) << MCLK_APBCMASK_SERCOM_Pos)          /* (MCLK_APBCMASK Mask) SERCOM */
...
#define MCLK_APBCMASK_ADC_Msk                 (_UINT32_(0x1) << MCLK_APBCMASK_ADC_Pos)             /* (MCLK_APBCMASK Mask) ADC */
...
#endif /* _PIC32CMJH00_MCLK_COMPONENT_H_ */
