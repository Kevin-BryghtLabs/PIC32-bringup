...
#ifndef _PIC32CMJH00_OSCCTRL_COMPONENT_H_
#define _PIC32CMJH00_OSCCTRL_COMPONENT_H_
...
#define OSCCTRL_STATUS_DPLLTO(value)          (OSCCTRL_STATUS_DPLLTO_Msk & (_UINT32_(value) << OSCCTRL_STATUS_DPLLTO_Pos)) /* Assignment of value for DPLLTO in the OSCCTRL_STATUS register */
...
#endif /* _PIC32CMJH00_OSCCTRL_COMPONENT_H_ */
