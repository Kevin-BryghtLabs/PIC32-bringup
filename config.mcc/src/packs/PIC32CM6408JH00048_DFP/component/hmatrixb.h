...
#define HMATRIXB_PRAS_M0PR(value)             (HMATRIXB_PRAS_M0PR_Msk & (_UINT32_(value) << HMATRIXB_PRAS_M0PR_Pos)) /* Assignment of value for M0PR in the HMATRIXB_PRAS register */
...
#define HMATRIXB_PRAS_M1PR(value)             (HMATRIXB_PRAS_M1PR_Msk & (_UINT32_(value) << HMATRIXB_PRAS_M1PR_Pos)) /* Assignment of value for M1PR in the HMATRIXB_PRAS register */
...
#define HMATRIXB_PRAS_M2PR(value)             (HMATRIXB_PRAS_M2PR_Msk & (_UINT32_(value) << HMATRIXB_PRAS_M2PR_Pos)) /* Assignment of value for M2PR in the HMATRIXB_PRAS register */
...
#define HMATRIXB_PRAS_M3PR(value)             (HMATRIXB_PRAS_M3PR_Msk & (_UINT32_(value) << HMATRIXB_PRAS_M3PR_Pos)) /* Assignment of value for M3PR in the HMATRIXB_PRAS register */
...
#define HMATRIXB_PRAS_M4PR(value)             (HMATRIXB_PRAS_M4PR_Msk & (_UINT32_(value) << HMATRIXB_PRAS_M4PR_Pos)) /* Assignment of value for M4PR in the HMATRIXB_PRAS register */
...
#define HMATRIXB_PRAS_M5PR(value)             (HMATRIXB_PRAS_M5PR_Msk & (_UINT32_(value) << HMATRIXB_PRAS_M5PR_Pos)) /* Assignment of value for M5PR in the HMATRIXB_PRAS register */
...
#define HMATRIXB_PRAS_M6PR(value)             (HMATRIXB_PRAS_M6PR_Msk & (_UINT32_(value) << HMATRIXB_PRAS_M6PR_Pos)) /* Assignment of value for M6PR in the HMATRIXB_PRAS register */
...
#define HMATRIXB_PRAS_M7PR(value)             (HMATRIXB_PRAS_M7PR_Msk & (_UINT32_(value) << HMATRIXB_PRAS_M7PR_Pos)) /* Assignment of value for M7PR in the HMATRIXB_PRAS register */
...
#define HMATRIXB_PRBS_M8PR(value)             (HMATRIXB_PRBS_M8PR_Msk & (_UINT32_(value) << HMATRIXB_PRBS_M8PR_Pos)) /* Assignment of value for M8PR in the HMATRIXB_PRBS register */
...
#define HMATRIXB_PRBS_M9PR(value)             (HMATRIXB_PRBS_M9PR_Msk & (_UINT32_(value) << HMATRIXB_PRBS_M9PR_Pos)) /* Assignment of value for M9PR in the HMATRIXB_PRBS register */
...
#define HMATRIXB_PRBS_M10PR(value)            (HMATRIXB_PRBS_M10PR_Msk & (_UINT32_(value) << HMATRIXB_PRBS_M10PR_Pos)) /* Assignment of value for M10PR in the HMATRIXB_PRBS register */
...
#define HMATRIXB_PRBS_M11PR(value)            (HMATRIXB_PRBS_M11PR_Msk & (_UINT32_(value) << HMATRIXB_PRBS_M11PR_Pos)) /* Assignment of value for M11PR in the HMATRIXB_PRBS register */
...
#define HMATRIXB_PRBS_M12PR(value)            (HMATRIXB_PRBS_M12PR_Msk & (_UINT32_(value) << HMATRIXB_PRBS_M12PR_Pos)) /* Assignment of value for M12PR in the HMATRIXB_PRBS register */
...
#define HMATRIXB_PRBS_M13PR(value)            (HMATRIXB_PRBS_M13PR_Msk & (_UINT32_(value) << HMATRIXB_PRBS_M13PR_Pos)) /* Assignment of value for M13PR in the HMATRIXB_PRBS register */
...
#define HMATRIXB_PRBS_M14PR(value)            (HMATRIXB_PRBS_M14PR_Msk & (_UINT32_(value) << HMATRIXB_PRBS_M14PR_Pos)) /* Assignment of value for M14PR in the HMATRIXB_PRBS register */
...
#define HMATRIXB_PRBS_M15PR(value)            (HMATRIXB_PRBS_M15PR_Msk & (_UINT32_(value) << HMATRIXB_PRBS_M15PR_Pos)) /* Assignment of value for M15PR in the HMATRIXB_PRBS register */
...
#define HMATRIXB_MCFG_ULBT(value)             (HMATRIXB_MCFG_ULBT_Msk & (_UINT32_(value) << HMATRIXB_MCFG_ULBT_Pos)) /* Assignment of value for ULBT in the HMATRIXB_MCFG register */
...
#define HMATRIXB_SCFG_SLOT_CYCLE(value)       (HMATRIXB_SCFG_SLOT_CYCLE_Msk & (_UINT32_(value) << HMATRIXB_SCFG_SLOT_CYCLE_Pos)) /* Assignment of value for SLOT_CYCLE in the HMATRIXB_SCFG register */
...
#define HMATRIXB_SCFG_DEFMSTR_TYPE(value)     (HMATRIXB_SCFG_DEFMSTR_TYPE_Msk & (_UINT32_(value) << HMATRIXB_SCFG_DEFMSTR_TYPE_Pos)) /* Assignment of value for DEFMSTR_TYPE in the HMATRIXB_SCFG register */
...
#define HMATRIXB_SCFG_FIXED_DEFMSTR(value)    (HMATRIXB_SCFG_FIXED_DEFMSTR_Msk & (_UINT32_(value) << HMATRIXB_SCFG_FIXED_DEFMSTR_Pos)) /* Assignment of value for FIXED_DEFMSTR in the HMATRIXB_SCFG register */
...
#define HMATRIXB_SCFG_ARBT(value)             (HMATRIXB_SCFG_ARBT_Msk & (_UINT32_(value) << HMATRIXB_SCFG_ARBT_Pos)) /* Assignment of value for ARBT in the HMATRIXB_SCFG register */
...
#define HMATRIXB_MRCR_RCB0(value)             (HMATRIXB_MRCR_RCB0_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB0_Pos)) /* Assignment of value for RCB0 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB1(value)             (HMATRIXB_MRCR_RCB1_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB1_Pos)) /* Assignment of value for RCB1 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB2(value)             (HMATRIXB_MRCR_RCB2_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB2_Pos)) /* Assignment of value for RCB2 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB3(value)             (HMATRIXB_MRCR_RCB3_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB3_Pos)) /* Assignment of value for RCB3 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB4(value)             (HMATRIXB_MRCR_RCB4_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB4_Pos)) /* Assignment of value for RCB4 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB5(value)             (HMATRIXB_MRCR_RCB5_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB5_Pos)) /* Assignment of value for RCB5 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB6(value)             (HMATRIXB_MRCR_RCB6_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB6_Pos)) /* Assignment of value for RCB6 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB7(value)             (HMATRIXB_MRCR_RCB7_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB7_Pos)) /* Assignment of value for RCB7 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB8(value)             (HMATRIXB_MRCR_RCB8_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB8_Pos)) /* Assignment of value for RCB8 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB9(value)             (HMATRIXB_MRCR_RCB9_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB9_Pos)) /* Assignment of value for RCB9 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB10(value)            (HMATRIXB_MRCR_RCB10_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB10_Pos)) /* Assignment of value for RCB10 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB11(value)            (HMATRIXB_MRCR_RCB11_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB11_Pos)) /* Assignment of value for RCB11 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB12(value)            (HMATRIXB_MRCR_RCB12_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB12_Pos)) /* Assignment of value for RCB12 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB13(value)            (HMATRIXB_MRCR_RCB13_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB13_Pos)) /* Assignment of value for RCB13 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB14(value)            (HMATRIXB_MRCR_RCB14_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB14_Pos)) /* Assignment of value for RCB14 in the HMATRIXB_MRCR register */
...
#define HMATRIXB_MRCR_RCB15(value)            (HMATRIXB_MRCR_RCB15_Msk & (_UINT32_(value) << HMATRIXB_MRCR_RCB15_Pos)) /* Assignment of value for RCB15 in the HMATRIXB_MRCR register */
...
#endif /* _PIC32CMJH00_HMATRIXB_COMPONENT_H_ */
