...
#ifndef _PIC32CMJH00_EVSYS_COMPONENT_H_
#define _PIC32CMJH00_EVSYS_COMPONENT_H_
...
#define EVSYS_CHSTATUS_Msk                    _UINT32_(0x003F003F)                                 /* (EVSYS_CHSTATUS) Register Mask  */

#define EVSYS_CHSTATUS_USRRDY_Pos             _UINT32_(0)                                          /* (EVSYS_CHSTATUS Position) Channel x User Ready */
#define EVSYS_CHSTATUS_USRRDY_Msk             (_UINT32_(0x3F) << EVSYS_CHSTATUS_USRRDY_Pos)        /* (EVSYS_CHSTATUS Mask) USRRDY */
#define EVSYS_CHSTATUS_USRRDY(value)          (EVSYS_CHSTATUS_USRRDY_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_USRRDY_Pos)) 
#define EVSYS_CHSTATUS_CHBUSY_Pos             _UINT32_(16)                                         /* (EVSYS_CHSTATUS Position) Channel 5 Busy */
#define EVSYS_CHSTATUS_CHBUSY_Msk             (_UINT32_(0x3F) << EVSYS_CHSTATUS_CHBUSY_Pos)        /* (EVSYS_CHSTATUS Mask) CHBUSY */
...
#define EVSYS_INTENCLR_Msk                    _UINT32_(0x003F003F)                                 /* (EVSYS_INTENCLR) Register Mask  */

#define EVSYS_INTENCLR_OVR_Pos                _UINT32_(0)                                          /* (EVSYS_INTENCLR Position) Channel x Overrun Interrupt Enable */
#define EVSYS_INTENCLR_OVR_Msk                (_UINT32_(0x3F) << EVSYS_INTENCLR_OVR_Pos)           /* (EVSYS_INTENCLR Mask) OVR */
#define EVSYS_INTENCLR_OVR(value)             (EVSYS_INTENCLR_OVR_Msk & (_UINT32_(value) << EVSYS_INTENCLR_OVR_Pos)) 
#define EVSYS_INTENCLR_EVD_Pos                _UINT32_(16)                                         /* (EVSYS_INTENCLR Position) Channel 5 Event Detection Interrupt Enable */
#define EVSYS_INTENCLR_EVD_Msk                (_UINT32_(0x3F) << EVSYS_INTENCLR_EVD_Pos)           /* (EVSYS_INTENCLR Mask) EVD */
...
#define EVSYS_INTENSET_Msk                    _UINT32_(0x003F003F)                                 /* (EVSYS_INTENSET) Register Mask  */

#define EVSYS_INTENSET_OVR_Pos                _UINT32_(0)                                          /* (EVSYS_INTENSET Position) Channel x Overrun Interrupt Enable */
#define EVSYS_INTENSET_OVR_Msk                (_UINT32_(0x3F) << EVSYS_INTENSET_OVR_Pos)           /* (EVSYS_INTENSET Mask) OVR */
#define EVSYS_INTENSET_OVR(value)             (EVSYS_INTENSET_OVR_Msk & (_UINT32_(value) << EVSYS_INTENSET_OVR_Pos)) 
#define EVSYS_INTENSET_EVD_Pos                _UINT32_(16)                                         /* (EVSYS_INTENSET Position) Channel 5 Event Detection Interrupt Enable */
#define EVSYS_INTENSET_EVD_Msk                (_UINT32_(0x3F) << EVSYS_INTENSET_EVD_Pos)           /* (EVSYS_INTENSET Mask) EVD */
...
#define EVSYS_INTFLAG_Msk                     _UINT32_(0x003F003F)                                 /* (EVSYS_INTFLAG) Register Mask  */

#define EVSYS_INTFLAG_OVR_Pos                 _UINT32_(0)                                          /* (EVSYS_INTFLAG Position) Channel x Overrun */
#define EVSYS_INTFLAG_OVR_Msk                 (_UINT32_(0x3F) << EVSYS_INTFLAG_OVR_Pos)            /* (EVSYS_INTFLAG Mask) OVR */
#define EVSYS_INTFLAG_OVR(value)              (EVSYS_INTFLAG_OVR_Msk & (_UINT32_(value) << EVSYS_INTFLAG_OVR_Pos)) 
#define EVSYS_INTFLAG_EVD_Pos                 _UINT32_(16)                                         /* (EVSYS_INTFLAG Position) Channel 5 Event Detection */
#define EVSYS_INTFLAG_EVD_Msk                 (_UINT32_(0x3F) << EVSYS_INTFLAG_EVD_Pos)            /* (EVSYS_INTFLAG Mask) EVD */
...
#define EVSYS_SWEVT_Msk                       _UINT32_(0x0000003F)                                 /* (EVSYS_SWEVT) Register Mask  */

#define EVSYS_SWEVT_CHANNEL_Pos               _UINT32_(0)                                          /* (EVSYS_SWEVT Position) Channel 5 Software Selection */
#define EVSYS_SWEVT_CHANNEL_Msk               (_UINT32_(0x3F) << EVSYS_SWEVT_CHANNEL_Pos)          /* (EVSYS_SWEVT Mask) CHANNEL */
...
#define EVSYS_USER_CHANNEL_Msk                (_UINT32_(0xF) << EVSYS_USER_CHANNEL_Pos)            /* (EVSYS_USER) Channel Event Selection Mask */
...
#define EVSYS_USER_Msk                        _UINT32_(0x0000000F)                                 /* (EVSYS_USER) Register Mask  */
...
#endif /* _PIC32CMJH00_EVSYS_COMPONENT_H_ */
