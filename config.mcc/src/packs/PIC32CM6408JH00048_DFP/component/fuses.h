...
#ifndef _PIC32CMJH00_FUSES_COMPONENT_H_
#define _PIC32CMJH00_FUSES_COMPONENT_H_
...
#define FUSES_TEMP_LOG_WORD_0_Msk             _UINT32_(0x00000000)                                 /* (FUSES_TEMP_LOG_WORD_0) Register Mask  */
...
#define FUSES_OTP5_WORD_0_ADC0_BIASREFBUF(value) (FUSES_OTP5_WORD_0_ADC0_BIASREFBUF_Msk & (_UINT32_(value) << FUSES_OTP5_WORD_0_ADC0_BIASREFBUF_Pos)) /* Assignment of value for ADC0_BIASREFBUF in the FUSES_OTP5_WORD_0 register */
...
#define FUSES_OTP5_WORD_0_ADC0_BIASCOMP(value) (FUSES_OTP5_WORD_0_ADC0_BIASCOMP_Msk & (_UINT32_(value) << FUSES_OTP5_WORD_0_ADC0_BIASCOMP_Pos)) /* Assignment of value for ADC0_BIASCOMP in the FUSES_OTP5_WORD_0 register */
#define FUSES_OTP5_WORD_0_Msk                 _UINT32_(0x0000003F)                                 /* (FUSES_OTP5_WORD_0) Register Mask  */
...
#define FUSES_USER_WORD_0_BODVDDUSERLEVEL(value) (FUSES_USER_WORD_0_BODVDDUSERLEVEL_Msk & (_UINT32_(value) << FUSES_USER_WORD_0_BODVDDUSERLEVEL_Pos)) /* Assignment of value for BODVDDUSERLEVEL in the FUSES_USER_WORD_0 register */
...
#define FUSES_USER_WORD_0_BODVDD_DIS(value)   (FUSES_USER_WORD_0_BODVDD_DIS_Msk & (_UINT32_(value) << FUSES_USER_WORD_0_BODVDD_DIS_Pos)) /* Assignment of value for BODVDD_DIS in the FUSES_USER_WORD_0 register */
...
#define FUSES_USER_WORD_0_BODVDD_ACTION(value) (FUSES_USER_WORD_0_BODVDD_ACTION_Msk & (_UINT32_(value) << FUSES_USER_WORD_0_BODVDD_ACTION_Pos)) /* Assignment of value for BODVDD_ACTION in the FUSES_USER_WORD_0 register */
...
#define FUSES_USER_WORD_1_WDT_WINDOW(value)   (FUSES_USER_WORD_1_WDT_WINDOW_Msk & (_UINT32_(value) << FUSES_USER_WORD_1_WDT_WINDOW_Pos)) /* Assignment of value for WDT_WINDOW in the FUSES_USER_WORD_1 register */
...
#define FUSES_USER_WORD_1_BODVDD_HYST(value)  (FUSES_USER_WORD_1_BODVDD_HYST_Msk & (_UINT32_(value) << FUSES_USER_WORD_1_BODVDD_HYST_Pos)) /* Assignment of value for BODVDD_HYST in the FUSES_USER_WORD_1 register */
...
/* OTP5_FUSES register API structure */
typedef struct
{
...
#endif /* _PIC32CMJH00_FUSES_COMPONENT_H_ */
