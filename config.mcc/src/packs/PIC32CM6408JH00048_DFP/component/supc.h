...
#ifndef _PIC32CMJH00_SUPC_COMPONENT_H_
#define _PIC32CMJH00_SUPC_COMPONENT_H_
...
#define SUPC_INTENCLR_BODCORERDY(value)       (SUPC_INTENCLR_BODCORERDY_Msk & (_UINT32_(value) << SUPC_INTENCLR_BODCORERDY_Pos)) /* Assignment of value for BODCORERDY in the SUPC_INTENCLR register */
...
#define SUPC_INTENCLR_BODCOREDET(value)       (SUPC_INTENCLR_BODCOREDET_Msk & (_UINT32_(value) << SUPC_INTENCLR_BODCOREDET_Pos)) /* Assignment of value for BODCOREDET in the SUPC_INTENCLR register */
...
#define SUPC_INTENCLR_BCORESRDY(value)        (SUPC_INTENCLR_BCORESRDY_Msk & (_UINT32_(value) << SUPC_INTENCLR_BCORESRDY_Pos)) /* Assignment of value for BCORESRDY in the SUPC_INTENCLR register */
...
#define SUPC_INTENSET_BODCORERDY(value)       (SUPC_INTENSET_BODCORERDY_Msk & (_UINT32_(value) << SUPC_INTENSET_BODCORERDY_Pos)) /* Assignment of value for BODCORERDY in the SUPC_INTENSET register */
...
#define SUPC_INTENSET_BODCOREDET(value)       (SUPC_INTENSET_BODCOREDET_Msk & (_UINT32_(value) << SUPC_INTENSET_BODCOREDET_Pos)) /* Assignment of value for BODCOREDET in the SUPC_INTENSET register */
...
#define SUPC_INTENSET_BCORESRDY(value)        (SUPC_INTENSET_BCORESRDY_Msk & (_UINT32_(value) << SUPC_INTENSET_BCORESRDY_Pos)) /* Assignment of value for BCORESRDY in the SUPC_INTENSET register */
...
#define SUPC_INTFLAG_BODCORERDY(value)        (SUPC_INTFLAG_BODCORERDY_Msk & (_UINT32_(value) << SUPC_INTFLAG_BODCORERDY_Pos)) /* Assignment of value for BODCORERDY in the SUPC_INTFLAG register */
...
#define SUPC_INTFLAG_BODCOREDET(value)        (SUPC_INTFLAG_BODCOREDET_Msk & (_UINT32_(value) << SUPC_INTFLAG_BODCOREDET_Pos)) /* Assignment of value for BODCOREDET in the SUPC_INTFLAG register */
...
#define SUPC_INTFLAG_BCORESRDY(value)         (SUPC_INTFLAG_BCORESRDY_Msk & (_UINT32_(value) << SUPC_INTFLAG_BCORESRDY_Pos)) /* Assignment of value for BCORESRDY in the SUPC_INTFLAG register */
...
#define SUPC_STATUS_BODCORERDY(value)         (SUPC_STATUS_BODCORERDY_Msk & (_UINT32_(value) << SUPC_STATUS_BODCORERDY_Pos)) /* Assignment of value for BODCORERDY in the SUPC_STATUS register */
...
#define SUPC_STATUS_BODCOREDET(value)         (SUPC_STATUS_BODCOREDET_Msk & (_UINT32_(value) << SUPC_STATUS_BODCOREDET_Pos)) /* Assignment of value for BODCOREDET in the SUPC_STATUS register */
...
#define SUPC_STATUS_BCORESRDY(value)          (SUPC_STATUS_BCORESRDY_Msk & (_UINT32_(value) << SUPC_STATUS_BCORESRDY_Pos)) /* Assignment of value for BCORESRDY in the SUPC_STATUS register */
...
#define SUPC_BODCORE_ENABLE(value)            (SUPC_BODCORE_ENABLE_Msk & (_UINT32_(value) << SUPC_BODCORE_ENABLE_Pos)) /* Assignment of value for ENABLE in the SUPC_BODCORE register */
...
#define SUPC_BODCORE_HYST(value)              (SUPC_BODCORE_HYST_Msk & (_UINT32_(value) << SUPC_BODCORE_HYST_Pos)) /* Assignment of value for HYST in the SUPC_BODCORE register */
...
#define SUPC_BODCORE_ACTION(value)            (SUPC_BODCORE_ACTION_Msk & (_UINT32_(value) << SUPC_BODCORE_ACTION_Pos)) /* Assignment of value for ACTION in the SUPC_BODCORE register */
...
#define SUPC_BODCORE_STDBYCFG(value)          (SUPC_BODCORE_STDBYCFG_Msk & (_UINT32_(value) << SUPC_BODCORE_STDBYCFG_Pos)) /* Assignment of value for STDBYCFG in the SUPC_BODCORE register */
...
#define SUPC_BODCORE_RUNSTDBY(value)          (SUPC_BODCORE_RUNSTDBY_Msk & (_UINT32_(value) << SUPC_BODCORE_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the SUPC_BODCORE register */
...
#define SUPC_BODCORE_ACTCFG(value)            (SUPC_BODCORE_ACTCFG_Msk & (_UINT32_(value) << SUPC_BODCORE_ACTCFG_Pos)) /* Assignment of value for ACTCFG in the SUPC_BODCORE register */
...
#define SUPC_BODCORE_PSEL(value)              (SUPC_BODCORE_PSEL_Msk & (_UINT32_(value) << SUPC_BODCORE_PSEL_Pos)) /* Assignment of value for PSEL in the SUPC_BODCORE register */
...
#define SUPC_BODCORE_LEVEL(value)             (SUPC_BODCORE_LEVEL_Msk & (_UINT32_(value) << SUPC_BODCORE_LEVEL_Pos)) /* Assignment of value for LEVEL in the SUPC_BODCORE register */
...
#endif /* _PIC32CMJH00_SUPC_COMPONENT_H_ */
